...
<?php
	if(isset($_FILES['file'])){
		move_uploaded_file($_FILES['file']['tmp_name'],'files/'.$_SESSION['faculty'].'-prelim.csv');
	}
?>
<!DOCTYPE HTML>
<html>
	...
	<script>
		$(document).ready(function(){
			...
			$('#grid').flexigrid({
				...
				title: 'UPLOAD PRELIM GRADES : <span>AY: <?php echo enlistment('ay')?> - <?php echo strtoupper(enlistment('sem')) ?></span>',
				height: windowHeight
			});
